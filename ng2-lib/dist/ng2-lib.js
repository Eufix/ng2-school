...
let AttrDirective = class AttrDirective {
    constructor(el) {
        this.el = el;
...
let StructDirective = class StructDirective {
    constructor(templateRef, viewContainer) {
        this.templateRef = templateRef;
        this.viewContainer = viewContainer;
        this.hasView = false;
    }
    set scStruct(condition) {
...
let ShowcaseModule = class ShowcaseModule {
};
...
//# sourceMappingURL=ng2-lib.js.map
